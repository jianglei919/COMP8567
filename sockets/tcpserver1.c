...
//$hostname -i for host ip address

int main(int argc, char *argv[])
{

    int sd, client, portNumber, num = 0;
    socklen_t len;
    ...
    // AF_INET: internet, SOCK_STREAM: TCP, 0:default network layer protocol: =ip

    // Store the IP address and PORT address in servAdd which is a variable of type struct sockaddr_in
    ...
    // bind: socket to ip address and port address
